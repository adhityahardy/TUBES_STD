...
void duakaliStasiun(List_parent P, List_relasi R, List_child C){
    ...
    while (B!=NULL) {
        ...
        if (n==2) {
            cout <<"Kereta "<<info(A)<<" dan "<<info(B)<<" akan mengunjungi dua stasiun yang sama "<<endl;
            n=0;
        }
        A=next(A);
        B=next(B);
...
void stasiunTerbanyak(List_child L, List_relasi R){
    ...
    if (P==NULL) {
        ...
        cout <<"Stasiun dengan jumlah Kereta terbanyak yaitu "<<info(Q)<<" dengan jumlah Kereta "<<maks<<" Kali"<<endl;
    }
}
...
void keretaTerbanyak(List_parent L, List_relasi R){
    ...
    if (P == NULL) {
        ...
        cout <<"Kereta yang paling sering menuju Stasiun tertentu yaitu Kereta "<<info(Q)<<" dengan jumlah  "<<maks<<" Kali"<<endl;
    }
}
